"""
Django settings for formsiq_project project.
...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-9q#z7(1$cs&#%)ny*5n7=u_fm0xaoq@vp6td*mzy+)gy_*$q7h')
...
ROOT_URLCONF = 'formsiq_project.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [],  # No templates needed - API only
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'formsiq_project.wsgi.application'
...
# No STATICFILES_DIRS needed - frontend is now deployed on Amplify
...
# CORS settings to allow requests from the Angular frontend
# CORS settings for frontend access
CORS_ALLOWED_ORIGINS = os.getenv('CORS_ALLOWED_ORIGINS', 'http://localhost:4200').split(',')

# Additional CORS settings for Amplify
